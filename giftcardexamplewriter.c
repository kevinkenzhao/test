...
void setupgc() {
	...
	examplegcd.merchant_id = "GiftCardz.comminws";
	examplegcd.customer_id = "DuaneGreenes Store 1451minws";
	...
	examplegcac.actual_signature = "3f34117635634bdac002e880d8570ad9";
}
